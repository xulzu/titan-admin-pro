    ...
    <div class="container">
      <div class="content">
        <div class="logo">
          ...
          <div class="logo__title flex items-center">
            <img :src="titanImg" class="inline h-[28px] mr-2" />
            防护引擎
          </div>
        </div>
        ...
        <div class="login-form">
          <div class="form_container">
            <div class="input_container">
              <label class="input_label" for="email_field">账户</label>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                height="24"
            ...
            <button title="Sign In" @click="submit" class="sign-in_btn">
              <span>登 录</span>
            </button>
          </div>
        </div>
...
const form = ref({ account: 'admin', password: 'x@12345o' })
function submit(e: any) {
  e.preventDefault()
  setTimeout(() => {
    loginStore.value = { username: '徐xx', etoken: 'xxxx' }
    toHome()
  }, 100)
}
</script>
